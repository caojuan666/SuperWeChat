...
//重写
     ...
     *      */
//    及時更新頭像
    public static void setAppPathUserAvatar(Context context, String path, ImageView imageView){
    ...
    public static void setAppUserNameWith(String username,TextView currentAppUserName) {
