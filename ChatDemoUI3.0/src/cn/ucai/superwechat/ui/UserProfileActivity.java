...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    EditText etNickname;
    @BindView(R.id.et_weinxinUserName)
    EditText etWeinxinUserName;
    ...
    private void initView() {
        ...
        ctitleTvTitle.setText(getString(R.string.app_name));

    }

    private void initListener() {
        EaseUserUtils.setCurrentAppAvater(this,ivAvater);
        EaseUserUtils.setCurrentAppNickName(etNickname);
        EaseUserUtils.setCurrentAppUserName(etWeinxinUserName);
        ...
        SuperWeChatHelper.getInstance().getUserProfileManager().asyncGetUserInfo(username, new EMValueCallBack<EaseUser>() {
            ...
            public void onSuccess(EaseUser user) {
                if (user != null) {
                    ...
                    etNickname.setText(user.getNick());
                    if (!TextUtils.isEmpty(user.getAvatar())) {
                        Glide.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.drawable.default_avatar).into(ivAvater);
                    } else {
                        Glide.with(UserProfileActivity.this).load(R.drawable.default_avatar).into(ivAvater);
                    }
                }
            }
...
//                    setPicToView(data);
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            ivAvater.setImageDrawable(drawable);
    ...
    @OnClick({R.id.iv_avater, R.id.et_nickname, R.id.et_weinxinUserName})
