...
//                    MFGT.gotoLiveActivity(PublicChatRoomsActivity.this);
//                } else {
...
//                            footLoadingLayout.setVisibility(View.GONE);
    ...
    @OnClick({R.id.ctitle_ivback, R.id.ctitle_tvTitle})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ctitle_ivback:
                MFGT.finish(this);
                break;
            case R.id.ctitle_tvTitle:
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("PublicChatRooms Page") // TODO: Define a title for the content shown.
