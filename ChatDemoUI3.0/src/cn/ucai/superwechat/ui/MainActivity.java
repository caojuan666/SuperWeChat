...
//		mTabs[0].setSelected(true);
        ctitleTvLeft.setVisibility(View.VISIBLE);
        ctitleIvAdd.setVisibility(View.VISIBLE);
        ...
        mTitlePopup.addAction(new ActionItem(this, R.string.menu_qrcode, R.drawable.icon_qunliao));
